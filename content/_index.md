...
sections:
  ...
  # 3) Servicios destacados (cta-image-paragraph, fondo azul, imágenes −40%, texto blanco)
  - block: cta-image-paragraph
    ...
    content:
      ...
      items:
        - title: "<span style='color:#FFFFFF'>Producción de videos educativos</span>"
          ...
          image_style: "max-width:28%"   # 80% -> 48% (−40%)
        - title: "<span style='color:#FFFFFF'>Ilustración científica y facilitación visual</span>"
          ...
          image_alt: "Ilustración Cúmulo"
          image_style: "max-width:28%"   # 80% -> 48%
  ...
  # 4.5) Quiénes somos (avatars −40% aprox, linkean a /authors/<slug>/)
  - block: markdown
    id: quienes-somos
    content:
      title: "Quiénes somos"
      text: |
        <div class="grid grid-cols-2 gap-8 items-start">
          ...
          <a href="/authors/julian/" class="text-center group" aria-label="Ir al perfil de Julián">
            <div class="rounded-full overflow-hidden mx-auto shadow w-16 h-16 md:w-20 md:h-20 flex items-center justify-center">
  ...
  - block: markdown
    ...
    content:
      text: |
        <style>
          /* Si el shortcode author_avatar no fuerza fit, centramos */
